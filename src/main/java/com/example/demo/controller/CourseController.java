...
public class CourseController {
    ...
    public ResponseEntity<List<CourseGradeDTO>> getGradesByCourseCode(@PathVariable String courseCode) {
        List<CourseGradeDTO> grades = courseService.getGradesByCourseCode(courseCode);
        if (grades.isEmpty()) {
